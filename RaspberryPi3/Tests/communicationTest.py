from RaspberryPi3.Tests.testsHelperFunctions import senseHatController
from RaspberryPi3.helperFunctions import messageService, IPService, sauceService
...
def receive_message_then_reply_test():
...
def get_ordered_sauce_test():
    ...
    db.child("Customer").child(orderNum).child("OrderInfo").child("Ingredients").child("sauce").set(original_sauce_choice)
...
def update_sauce_level_test():
    ...
    actual_sauce_level = sauceService.check_sauce_level()
